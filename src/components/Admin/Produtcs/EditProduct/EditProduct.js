...
import { updateInfoProductsApi } from '../../../../api/products';
...
export default function EditProduct(props) {
    const { product, setReloadProducts, setIsVisibleModal } = props;
    return (
        <div className="edit-product-form">
            <EditForm product={product} setIsVisibleModal={setIsVisibleModal} setReloadProducts={setReloadProducts} />
        </div>
    );
}
...
function EditForm(props) {
    ...
    useEffect(()=>{
        setPersonName(product.description);
    },[product])
    ...
    return (
        <Formik
            ...
            onSubmit={(valores, { resetForm }) => {
                ...
                setValidated(true);
                updateInfoProductsApi(token, valores, product._id).then(result => {
            ...
            {({
                ...
                >
                    ...
                    <div className="d-grid gap-2">
                        <Button className="botonS" type="submit" onClick={handleClick}>Guardar</Button>
                    </div>
                </Box>
            )}
        </Formik>
